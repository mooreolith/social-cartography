      ...
      */ 
      ...
      $('#role-description').on('keydown', event => {
        if(event.keyCode == 13) {
          ...
          if(group === undefined){
            group = $('#display').social_cartography('add_group', {name: group_name, picture: 'img/group.jpg'});
          }

          $('#display').social_cartography('add_role', person, group);
